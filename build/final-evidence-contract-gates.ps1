...
Need 'tools/lifecycle-core-acceptance.ps1' 'MaintenanceTaskHealthyAfterRepair' 'repair must preserve the limited current-user maintenance task.'
Need 'tools/lifecycle-core-acceptance.ps1' 'MaintenanceTaskRemoved' 'uninstall must remove the maintenance task.'
...
Need 'tools/final-production-core.ps1' 'MaintenanceTaskPreservedAcrossRepairAndRemovedOnUninstall' 'final release must prove transparent maintenance lifecycle cleanup.'
Need 'tools/final-production-core.ps1' 'MaintenanceTaskHealthyAfterRepair' 'final gate must validate maintenance task after repair.'
Need 'tools/final-production-core.ps1' 'MaintenanceTaskRemoved' 'final gate must validate maintenance task removal.'
